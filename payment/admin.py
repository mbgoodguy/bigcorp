...
class ShippingAdressAdmin(ModelAdmin):
    ...
    @admin.display(description='Full_name', empty_value='Noname')
    def full_name_bold(self, obj):
        return format_html("<b style='font-weight: bold;'>{}</b>", obj.full_name)


admin.register(ShippingAdressAdmin)  # second variant of model registration instead @admin.register()
